...
class SettingsPanel(BaseSettingsPanel):
    ...
    def makeSettings(self, sizer):
        ...
        self.radio_box_json_query_engines = wx.RadioBox(
            self, wx.ID_ANY, 'JSON query Engine',
            choices=['JQ', 'JSONPath'],
            majorDimension=len(json_query_engines), style=wx.RA_SPECIFY_COLS
        )
    ...
    def onSave(self):
        config.conf['json'] = {
            'query_engine': self.radio_box_json_query_engines.GetStringSelection().lower(),
        }
